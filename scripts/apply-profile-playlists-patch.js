...
// Existing playlists are shared on first load. Files that appear after startup
// are assigned to the active profile.
edit(
  'src/back/index.ts',
...
// Profile-specific view for all playlists, including the Favorites projection.
edit(
...
// New playlists created, imported, or duplicated through the launcher are owned
// by the active profile. Existing playlist updates preserve their owner.
edit(
  'src/back/playlist.ts',
...
// Profile switching immediately refreshes the visible playlist collection.
edit(
...
// Direct playlist reads respect ownership.
edit(
  'src/back/responses.ts',
